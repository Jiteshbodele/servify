...
from .views import MeHandler, ChangePasswordHandler, ApproveProviderHandler, AddressListHandler, AddressDetailHandler
urlpatterns = [
    path('me/',                              MeHandler.as_view()),
    path('me/change-password/',              ChangePasswordHandler.as_view()),
